...
<!-- 
   ...
   <div class="navbar-header visible-xs">
        ...
        <!-- <div id="navbar" class="">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li id="login"><a href="../SistemaOutsideFood/index.php">Área Restrita</a></li> -->
 ...
 <header id="sp-header" class="menu-fixed-out">
  <div class="innerheader">
    ...
    <nav role='navigation'>
      <a class="hamburger" href="#0" title="Menu"><span>Menu</span></a>
            <ul>
        <li><a href="#">Home</a></li>
        <li><a href="#story">História</a></li>
...
<!--         <div class="bottom text-center">
            <a id="scrollDownArrow" href="#story"><i class="fa fa-chevron-down"></i></a>
        </div> -->
    </div>
    <!-- /#header -->
...
<!-- 
    <div id="fotos" class="light-wrapper">
        <section class="ss-style-top"></section>
...
<!--         <section class="ss-style-bottom"></section>
    ...
    <div id="contato" class="parallax pricing" style="background-color: #FBFBFB;">
        <div class="container inner">
            <br><br>
